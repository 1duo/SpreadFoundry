...
configure_refresh() {
  ...
  export SPREAD_LIVE_SIGNAL_ARTIFACT="${SPREAD_LIVE_SIGNAL_ARTIFACT:-var/live_signal_refresh_source.json}"
...
import_legacy_refresh_env() {
  ...
  export SPREAD_LIVE_SIGNAL_ARTIFACT="${SPREAD_LIVE_SIGNAL_ARTIFACT:-${SPREAD_CANARY_CANDIDATE:-var/live_signal_refresh_source.json}}" # legacy migration
}
