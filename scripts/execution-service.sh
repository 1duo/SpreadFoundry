...
configure_tradier() {
  ...
  export SPREAD_EXECUTION_ACCOUNT_CASH_SOURCE="${SPREAD_EXECUTION_ACCOUNT_CASH_SOURCE:-broker}"
  export SPREAD_CANARY_RISK_FREE_CASH_BUFFER_PCT="${SPREAD_CANARY_RISK_FREE_CASH_BUFFER_PCT:-0.25}"
  export SPREAD_CANARY_RISK_MAX_DAILY_LOSS_PCT="${SPREAD_CANARY_RISK_MAX_DAILY_LOSS_PCT:-0.03}"
  export SPREAD_CANARY_RISK_MAX_OPEN_LOSS_PCT="${SPREAD_CANARY_RISK_MAX_OPEN_LOSS_PCT:-0.03}"
  persist_execution_env
...
readiness_report() {
  ...
  local account_cash_source="${SPREAD_EXECUTION_ACCOUNT_CASH_SOURCE:-configured}"
  ...
  local cli_args=(
    ...
    --account-cash-source "$account_cash_source"
  ...
  if [[ -n "${SPREAD_CANARY_RISK_FREE_CASH_BUFFER_PCT:-}" ]]; then
    cli_args+=(--free-cash-buffer-pct "$SPREAD_CANARY_RISK_FREE_CASH_BUFFER_PCT")
  fi
  if [[ -n "${SPREAD_CANARY_RISK_MAX_DAILY_LOSS_PCT:-}" ]]; then
    cli_args+=(--max-daily-loss-pct "$SPREAD_CANARY_RISK_MAX_DAILY_LOSS_PCT")
  fi
  if [[ -n "${SPREAD_CANARY_RISK_MAX_OPEN_LOSS_PCT:-}" ]]; then
    cli_args+=(--max-open-loss-pct "$SPREAD_CANARY_RISK_MAX_OPEN_LOSS_PCT")
  fi
...
import_legacy_execution_env() {
  ...
  export SPREAD_EXECUTION_ACCOUNT_CASH_SOURCE="${SPREAD_EXECUTION_ACCOUNT_CASH_SOURCE:-${SPREAD_CANARY_ACCOUNT_CASH_SOURCE:-configured}}"
  ...
  export SPREAD_CANARY_RISK_FREE_CASH_BUFFER_PCT="${SPREAD_CANARY_RISK_FREE_CASH_BUFFER_PCT:-${SPREAD_CANARY_FREE_CASH_BUFFER_PCT:-}}"
  ...
  export SPREAD_CANARY_RISK_MAX_DAILY_LOSS_PCT="${SPREAD_CANARY_RISK_MAX_DAILY_LOSS_PCT:-${SPREAD_CANARY_MAX_DAILY_LOSS_PCT:-}}"
  export SPREAD_CANARY_RISK_MAX_OPEN_LOSS_PCT="${SPREAD_CANARY_RISK_MAX_OPEN_LOSS_PCT:-${SPREAD_CANARY_MAX_OPEN_LOSS_PCT:-}}"
}
